 ...
 */
public class ModelRhodonitu extends ModelGem {
    ...
    public ModelRhodonitu() {
		super(0.0F, 0.0F, 94, 62, false, -2F);
        ...
        this.lower_arm_right = new ModelRenderer(this, 40, 18);
        this.lower_arm_right.setRotationPoint(-4.5F, 1.5F, -4.0F);
        this.lower_arm_right.addBox(0.0F, 0.0F, 0.0F, 2, 2, 8, 0.0F);
        this.setRotateAngle(lower_arm_right, 0.0F, 0.6108652381980153F, 0.0F);
        this.lower_arm_left = new ModelRenderer(this, 40, 28);
        this.lower_arm_left.setRotationPoint(8.6F, 1.5F, -5.0F);
        this.lower_arm_left.addBox(0.0F, 0.0F, 0.0F, 2, 2, 8, 0.0F);
        this.setRotateAngle(lower_arm_left, 0.0F, -0.6108652381980153F, 0.0F);
        ...
        this.bipedHead.setRotationPoint(-6.5F, -13.0F, -2.0F);
        ...
        this.bipedWaist.addChild(this.lower_arm_right);
        this.bipedWaist.addChild(this.lower_arm_left);
