...
public class ModelEmerald extends ModelGem {
    ...
    public ModelEmerald() {
    	super(0.0F, 0.0F, 64, 80, false, 7F);
        this.bipedNeck = new ModelRenderer(this, 12, 20);
        this.bipedNeck.setRotationPoint(0.0F, -12.0F, 0.0F);
        this.bipedNeck.addBox(-1.0F, 0.0F, -1.0F, 2, 2, 2, 0.0F);
        this.bipedRightLeg = new ModelRenderer(this, 44, 35);
        this.bipedRightLeg.setRotationPoint(-2.0F, 8.0F, 0.0F);
        this.bipedRightLeg.addBox(-1.5F, 0.0F, -1.5F, 3, 16, 3, 0.0F);
        this.bipedBody = new ModelRenderer(this, 12, 32);
        ...
        this.bipedRightShoulder = new ModelRenderer(this, 36, 54);
        this.bipedRightShoulder.setRotationPoint(-8.0F, -10.0F, 0.0F);
        this.bipedRightShoulder.addBox(-3.0F, 0.0F, -3.5F, 6, 5, 7, 0.0F);
        this.bipedHips = new ModelRenderer(this, 12, 47);
        this.bipedHips.setRotationPoint(0.0F, -1.0F, 0.0F);
        this.bipedHips.addBox(-4.0F, 0.0F, -2.0F, 8, 9, 4, 0.0F);
        this.bipedHeadwear = new ModelRenderer(this, 0, 0);
        this.bipedHeadwear.setRotationPoint(0.0F, -12.0F, 0.0F);
        this.bipedHeadwear.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F);
        this.bipedLeftShoulder = new ModelRenderer(this, 36, 66);
        this.bipedLeftShoulder.setRotationPoint(8.0F, -10.0F, 0.0F);
        this.bipedLeftShoulder.addBox(-3.0F, 0.0F, -3.5F, 6, 5, 7, 0.0F);
        this.bipedHead = new ModelRenderer(this, 12, 16);
        ...
        this.bipedLeftLeg = new ModelRenderer(this, 44, 16);
        this.bipedLeftLeg.setRotationPoint(2.0F, 8.0F, 0.0F);
        this.bipedLeftLeg.addBox(-1.5F, 0.0F, -1.5F, 3, 16, 3, 0.0F);
        this.bipedHeadwear2 = new ModelRenderer(this, 32, 0);
        this.bipedHeadwear2.setRotationPoint(0.0F, -1.5F, 5.0F);
        this.bipedHeadwear2.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F);
        this.setRotateAngle(bipedHeadwear2, 0.3490658503988659F, 0.0F, 0.0F);
        this.bipedLeftShoulder.addChild(this.bipedLeftArm);
        this.bipedRightShoulder.addChild(this.bipedRightArm);
        this.bipedHeadwear.addChild(this.bipedHeadwear2);
    }
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        GlStateManager.translate(this.bipedHeadwear.rotationPointX * scale, this.bipedHeadwear.rotationPointY * scale, this.bipedHeadwear.rotationPointZ * scale);
