...
public class EntityRuby extends EntityGem implements IAnimals {
	...
	public EntityRuby(World worldIn) {
        ...
        this.tasks.addTask(3, new EntityAIProtectionFuse(this, EntityRuby.class, EntityGarnet.class, 16D));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
    	this.setSpecial(this.rand.nextInt(1));
	...
	public EntityRuby fuse(EntityRuby other) {
		...
		ruby.setGloveColor(this.getGloveColor());
	...
	public int generateSkinColor() {
        ...
        return Colors.arbiLerp(EntityRuby.SKIN_COLORS.get(this.getSpecial()));
	}
	@Override
	...
	protected int generateEyeColor() {
        ...
        return Colors.arbiLerp(EntityRuby.EYE_COLORS.get(this.getSpecial()));
	}
	@Override
	...
	protected int generateUniformStyle() {
		return this.rand.nextInt(EntityRuby.NUM_UNIFORMS);
	}
	@Override
	protected int generateInsigniaStyle() {
		return this.rand.nextInt(EntityRuby.NUM_INSIGNIAS);
	}
	@Override
	protected int generateGloveStyle() {
		return this.rand.nextInt(EntityRuby.NUM_GLOVES);
	}
	@Override
