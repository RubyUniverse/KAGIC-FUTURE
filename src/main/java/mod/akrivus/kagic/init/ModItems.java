...
public class ModItems {
	...
	public static final ItemGem COMMON_AMETHYST_GEM = new ItemGem("amethyst_0");
	public static final ItemGem LACE_AMETHYST_GEM = new ItemGem("amethyst_1");
    ...
    public static final ItemGem YELLOW_SAPPHIRE_GEM = new ItemGem("sapphire_2");
    public static final ItemGem PINK_SAPPHIRE_GEM = new ItemGem("sapphire_3");
    public static final ItemGem GRAY_SAPPHIRE_GEM = new ItemGem("sapphire_4");
    public static final ItemGem TURQUOISE_SAPPHIRE_GEM = new ItemGem("sapphire_5");
    public static final ItemGem PURPLE_SAPPHIRE_GEM = new ItemGem("sapphire_6");
    public static final ItemGem BLUE_SAPPHIRE_GEM = new ItemGem("sapphire_7");
    public static final ItemGem BROWN_SAPPHIRE_GEM = new ItemGem("sapphire_8");
    public static final ItemGem GREEN_SAPPHIRE_GEM = new ItemGem("sapphire_9");
    public static final ItemGem BLACK_SAPPHIRE_GEM = new ItemGem("sapphire_10");
    public static final ItemGem PADPARADSCHA_SAPPHIRE_GEM = new ItemGem("sapphire_11");
    public static final ItemGem BICOLOR_SAPPHIRE_GEM = new ItemGem("sapphire_12");
    public static final ItemGem WINZA_SAPPHIRE_GEM = new ItemGem("sapphire_13");
	...
	public static final ItemGem CRACKED_COMMON_AMETHYST_GEM = new ItemGem("amethyst_0", true);
	public static final ItemGem CRACKED_LACE_AMETHYST_GEM = new ItemGem("amethyst_1", true);
    ...
    public static final ItemGem CRACKED_YELLOW_SAPPHIRE_GEM = new ItemGem("sapphire_2", true);
    public static final ItemGem CRACKED_PINK_SAPPHIRE_GEM = new ItemGem("sapphire_3", true);
    public static final ItemGem CRACKED_GRAY_SAPPHIRE_GEM = new ItemGem("sapphire_4", true);
    public static final ItemGem CRACKED_TURQUOISE_SAPPHIRE_GEM = new ItemGem("sapphire_5", true);
    public static final ItemGem CRACKED_PURPLE_SAPPHIRE_GEM = new ItemGem("sapphire_6", true);
    public static final ItemGem CRACKED_BLUE_SAPPHIRE_GEM = new ItemGem("sapphire_7", true);
    public static final ItemGem CRACKED_BROWN_SAPPHIRE_GEM = new ItemGem("sapphire_8", true);
    public static final ItemGem CRACKED_GREEN_SAPPHIRE_GEM = new ItemGem("sapphire_9", true);
    public static final ItemGem CRACKED_BLACK_SAPPHIRE_GEM = new ItemGem("sapphire_10", true);
    public static final ItemGem CRACKED_PADPARADSCHA_SAPPHIRE_GEM = new ItemGem("sapphire_11", true);
    public static final ItemGem CRACKED_BICOLOR_SAPPHIRE_GEM = new ItemGem("sapphire_12", true);
    public static final ItemGem CRACKED_WINZA_SAPPHIRE_GEM = new ItemGem("sapphire_13", true);
	...
	public static void registerItems(RegistryEvent.Register<Item> event) {
		...
		registerGem(COMMON_AMETHYST_GEM, CRACKED_COMMON_AMETHYST_GEM, event);
		registerGem(LACE_AMETHYST_GEM, CRACKED_LACE_AMETHYST_GEM, event);
		...
		ModItems.registerGem(WHITE_SAPPHIRE_GEM, CRACKED_WHITE_SAPPHIRE_GEM, event);
		ModItems.registerGem(ORANGE_SAPPHIRE_GEM, CRACKED_ORANGE_SAPPHIRE_GEM, event);
	    ModItems.registerGem(YELLOW_SAPPHIRE_GEM, CRACKED_YELLOW_SAPPHIRE_GEM, event);
	    ModItems.registerGem(PINK_SAPPHIRE_GEM, CRACKED_PINK_SAPPHIRE_GEM, event);
	    ModItems.registerGem(GRAY_SAPPHIRE_GEM, CRACKED_GRAY_SAPPHIRE_GEM, event);
	    ModItems.registerGem(TURQUOISE_SAPPHIRE_GEM, CRACKED_TURQUOISE_SAPPHIRE_GEM, event);
	    ModItems.registerGem(PURPLE_SAPPHIRE_GEM, CRACKED_PURPLE_SAPPHIRE_GEM, event);
	    ModItems.registerGem(BLUE_SAPPHIRE_GEM, CRACKED_BLUE_SAPPHIRE_GEM, event);
	    ModItems.registerGem(BROWN_SAPPHIRE_GEM, CRACKED_BROWN_SAPPHIRE_GEM, event);
	    ModItems.registerGem(GREEN_SAPPHIRE_GEM, CRACKED_GREEN_SAPPHIRE_GEM, event);
	    ModItems.registerGem(BLACK_SAPPHIRE_GEM, CRACKED_BLACK_SAPPHIRE_GEM, event);
	    ModItems.registerGem(PADPARADSCHA_SAPPHIRE_GEM, CRACKED_PADPARADSCHA_SAPPHIRE_GEM, event);
	    ModItems.registerGem(BICOLOR_SAPPHIRE_GEM, CRACKED_BICOLOR_SAPPHIRE_GEM, event);
	    ModItems.registerGem(WINZA_SAPPHIRE_GEM, CRACKED_WINZA_SAPPHIRE_GEM, event);
	    ModItems.registerGem(SAPPHIRE_GEM, CRACKED_SAPPHIRE_GEM, event);
